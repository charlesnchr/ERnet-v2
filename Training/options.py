...
parser.add_argument('--logimage', action='store_true', help='only save images in tensorboard file')
...
parser.add_argument('--rootTesting', type=str, default=None, help='files for testFunction')
parser.add_argument('--testFunction', type=str, default=None, help='extra test function to run')
parser.add_argument('--testFunctionArgs', type=str, default=None, help='e.g. imgSize,100,nimg,5')
